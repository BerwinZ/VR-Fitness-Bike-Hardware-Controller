...
double negative0point = 420;
double positive0point = 420;
double positive45point = 832;
double fullpointAngle = 20;
double angle = 0;
double k1, b1, k2, b2;
...
void setup() {
  ...
  k1 = fullpointAngle / (negative0point - negative45point);
  b1 = -1 * negative0point * k1;
  k2 = fullpointAngle / (positive45point - positive0point);
